    ...
    return (
        <div className={cn(
            ...
            <motion.div
                ref={islandRef}
                className={cn(
                    "pointer-events-auto overflow-visible flex items-center justify-center relative will-change-[width,height,border-radius]",
                    ...
                    (!isDockedTop || (settings.nonNotchMode && mode === 'idle' && !isHovered && !expanded) || hideForMaximized) && "before:hidden after:hidden",
                ...
                onWheel={handleWheel}
                style={{
                    cursor: hideForMaximized ? 'default' : 'pointer',
